...
| 19 | **Uniformisation couche Services** (étude homogénéité 24/09) — 2 bugs transactionnels P0 (rollback inhibé : `CraServices::Create`, `MissionServices::Create`) · règle FC-07 de liaison auto CRA↔Mission **plus implémentée nulle part** (CraMissionLinker 0 appelant — arbitrage produit) · mapping contrôleur incomplet (500 au lieu de 409) · vocabulaire d'erreurs fragmenté (3 vocables/invariant, fuites `e.message`) · specs absentes (Update/Destroy CRA, CompanyServices 0 spec) · dead code (ApmService, rate limiting RedisBackend jamais branché) — plan S-1…S-8 proposé, **arbitrages CTO requis** (S-2, S-6) avant exécution | 🔴 | étude `technical/audits/2026_09_24_services_layer_homogeneity_study.md` §9 (S-1…S-8) · mémoire fc08::012 (audit Swagger/Postman) |
