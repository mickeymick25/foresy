...
**Sources :**
- Rapport de vérification : `docs/technical/changes/[DONE]_2026_09_16_D1-D11_Debt_Verification_Report.md`
...
- **Fichier 2 :** `docs/technical/[DONE]_2026_08_31_fc08_implementation_tracker.md` (journal D-5) — « p6_1 … — 23/0 » rectifié : p6_1 = 10/0 ; 23 = cumul 13+10 des deux specs D-5
...
- **Description PR :** `docs/technical/changes/[DONE]_2026_09_16_D4_PR_Description.md` (format maison)
...
- `docs/technical/[DONE]_2026_08_31_fc08_implementation_tracker.md` : journal D-5 rectifié — p6_1 = 10/0, 23 = cumul 13+10 des deux specs D-5 (mention de rectification datée)
- **Nature :** commentaire + docs, sans effet comportemental — l'evidence E2E ×2 du 16/09 reste valable
- **Commit :** `4caa50ec`
...
- Branche `chore/d4-e2e-scripts-repair` poussée sur origin (inclut le présent lot docs) ; description PR prête : `docs/technical/changes/[DONE]_2026_09_16_D4_PR_Description.md`
...
- Guide `docs/technical/testing/2026_09_16_line_coverage.md` (procédure, lecture, baseline, politique de seuils 2 phases)
...
- Rapport de vérification : `docs/technical/changes/[DONE]_2026_09_16_D1-D11_Debt_Verification_Report.md`
- Registre de dette : `docs/technical/2026_09_14_fc08_debt_register.md` (§4-7)
- Journal FC-08 : `docs/technical/[DONE]_2026_08_31_fc08_implementation_tracker.md`
- Mémoire : `memory/2026-09-14-fc08-implementation.md` (fc08::001–007)
- Standard platinium : `docs/technical/audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md` (§1.3)