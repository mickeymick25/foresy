...
- Couverture de **lignes** (SimpleCov) : aucun outil en place — chantier D-2 (voir `2026_09_14_fc08_debt_register.md`)
...
**Références :** tracker `docs/technical/[DONE]_2026_08_31_fc08_implementation_tracker.md` · registre de dette `docs/technical/2026_09_14_fc08_debt_register.md` · contrat §54-63