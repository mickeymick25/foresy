...
**Dette :** D-2 (registre `docs/technical/2026_09_14_fc08_debt_register.md`) — seule dette active restante de la vague D-1→D-11 (checkpoint co-CTO : 10/11 closes)
**Chiffrage :** `docs/technical/changes/[DONE]_2026_09_16_D2_SimpleCov_Chiffrage.md` (~3 h effectives, mergé via PR #28)
...
| **P5** | Documentation : guide + registre + suivi + décisions tracées | `docs/technical/testing/2026_09_16_line_coverage.md` créé ; registre/suivi à jour (incl. rattrapage shas merges A6 `8d19bce8` / D-11 `689a4b15`) | ✅ fait |
...
### P5 — Documentation
- **`docs/technical/testing/2026_09_16_line_coverage.md`** : procédure d'exécution, lecture des rapports, politique de seuils en 2 phases (baseline → 95 % post-mesure), décisions D-2.1/2.2/2.3 actées
...
- Registre : `docs/technical/2026_09_14_fc08_debt_register.md` (D-2, §6 item 5)
- Chiffrage : `docs/technical/changes/[DONE]_2026_09_16_D2_SimpleCov_Chiffrage.md`
- Checkpoint co-CTO 16/09 : PR #25→#28 mergées, vague 10/11 closes, seule D-2 active
- Guide isolation bases : `docs/technical/testing/2026_09_15_test_database_isolation.md`
- Suivi vague corrective : `docs/technical/[DONE]_2026_09_16_d1_d11_corrective_actions_tracker.md`