...
**Plan de suivi :** `docs/technical/fc08_implementation_tracker.md` (16/19 tâches + DoD 9/9)
...
- **Rapport de couverture** : `docs/technical/testing/fc08_coverage_report.md` — 19/22 invariants entièrement couverts (matrice INV-01→22)
- **Registre de dette** : `docs/technical/fc08_debt_register.md` — D-1…D-7 (dont D-2 SimpleCov, D-4 scripts E2E hérités, D-5 Brakeman préexistants — hors périmètre FC-08)
