...
**Plan de campagne :** `docs/technical/testing/coverage_campaign_p6.md` · Suivi : `docs/technical/testing/p6_wave1_tracker.md` (journal complet)
...
| Divergence | Contrat 429 aligné sur l'implémentation (`error_contract.md`) — **doc seulement, aucun breaking change** | `2c6a3cd7` |
...
- **Gates par étape** : journal complet au tracker (`docs/technical/testing/p6_wave1_tracker.md`) — chaque étape : RSpec complet, RuboCop 0, Brakeman 0, SimpleCov réel mesuré (jamais projeté)
