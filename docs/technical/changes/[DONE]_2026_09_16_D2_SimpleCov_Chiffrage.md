...
**Dette :** D-2 (registre `docs/technical/2026_09_14_fc08_debt_register.md`) — « Aucun outil de couverture de lignes en place (gem absente, `coverage/` vide) — chantier transverse à chiffrer séparément »
...
| 7 | Docs | registre D-2 → résolue ; guide `docs/technical/testing/2026_09_16_line_coverage.md` (procédure, lecture, seuils) + journal | 45 min |
...
5. **Baseline mesurée (16/09)** : **72.78 % lignes (2879/3956) / 44.82 % branches (744/1660)** — détail par couche et fichiers sous-couverts : `docs/technical/testing/2026_09_16_line_coverage.md` §4
...
- Suivi : `docs/technical/[DONE]_2026_09_16_d1_d11_corrective_actions_tracker.md` (action 8)