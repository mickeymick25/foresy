...
- [Tâche P6.1 — Sécuriser `GitLedgerRepository`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p61--sécuriser-gitledgerrepository-contre-les-injections-shell)
- [Tâche P6.2 — Nettoyer `CraEntry`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p62--nettoyer-craentry--callbacks-commentés--attr_writer-tdd)
- [Tâche P6.3 — Évaluer migration `users` PK](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p63--évaluer-la-migration-users-pk-bigint--uuid-long-terme)