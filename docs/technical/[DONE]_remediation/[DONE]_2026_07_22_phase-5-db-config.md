...
- [Tâche P5.1 — Migrer `users.uuid`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p51--migrer-usersuuid-de-varchar36-vers-uuid-natif-postgresql)
- [Tâche P5.2 — Migrer `role` en enum PG](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p52--migrer-user_missionsrole-et-user_crasrole-en-enum-postgresql)
- [Tâche P5.3 — Renommer module `App`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p53--renommer-le-module-rails-app-en-foresy)
- [Tâche P5.4 — Aligner `load_defaults`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p54--aligner-configload_defaults-sur-la-version-rails-81)