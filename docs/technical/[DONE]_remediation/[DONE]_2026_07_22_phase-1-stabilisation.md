...
- [Tâche P1.1 — Résoudre crash `Domain::CraEntry`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p11--résoudre-le-crash-runtime-domaincraentrycraentry-inexistant)
- [Tâche P1.2 — Résoudre conflit `rescue_from`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p12--résoudre-le-conflit-rescue_from-standarderror)