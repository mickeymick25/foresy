...
**Critères Platinum** : rspec ✅ / rubocop ✅ / brakeman ✅ / zeitwerk:check ✅ + tests de contrat RSwag mis à jour + document `2026_08_18_error_contract.md` créé.
...
**Document de référence :** `Foresy/docs/technical/guides/2026_08_18_error_contract.md` (à créer)
...
- **Validation Platinum :** rspec ✅ / rubocop ✅ / brakeman ✅ / zeitwerk ✅ + tests RSwag à jour + `2026_08_18_error_contract.md` créé
...
- [Tâche P2.1 — Évaluer et merger Phase 1.9](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p21--évaluer-et-merger-la-phase-19-standardized-error-contract)
- [Tâche P2.2 — Supprimer `ErrorRenderable`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p22--supprimer-le-concern-orphelin-errorrenderable)
- [Tâche P2.3 — Migrer `render_fc07_error`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p23--migrer-render_fc07_error-vers-le-format-unifié)