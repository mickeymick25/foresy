...
- [Tâche P3.1 — Supprimer code mort `app/lib`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p31--supprimer-le-code-mort-dans-applib)
- [Tâche P3.2 — Supprimer concerns orphelins](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p32--traiter-les-concerns-modèles-orphelins)