...
**Document parent :** [`docs/technical/audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md)
...
Chaque tâche suit le cycle **🔴 RED → 🟢 GREEN → 🔵 REFACTOR** en 3 commits distincts (voir [§1.3 du document principal](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#13-méthodologie-tdd--ddd--niveau-platinum)).
...
- [Tâche P4.1 — Aligner héritage contrôleurs](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p41--aligner-lhéritage-des-contrôleurs-sur-basecontroller)
- [Tâche P4.2 — Extraire `extract_client_ip_for_rate_limiting`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p42--extraire-extract_client_ip_for_rate_limiting-dans-un-concern-partagé)
- [Tâche P4.3 — Extraire logique métier `MissionsController`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p43--extraire-la-logique-métier-de-missionscontroller-dans-des-services)
- [Tâche P4.4 — Nettoyer 3 couches services CRA Entries](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p44--nettoyer-les-3-couches-de-services-cra-entries)
- [Tâche P4.5 — Unifier format 429 `UsersController`](../audits/[DONE]_2026_07_22_Architecture_Debt_Audit_and_Plan.md#p45--unifier-le-format-429-de-userscontroller)