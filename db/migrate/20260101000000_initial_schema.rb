...
# Migration initiale unique — Schéma complet Foresy (squash de 16 migrations)
# Crée toute la base de données dans son état final (post-remédiation architecture).
# Aucune donnée de production à préserver (projet pré-launch).
class InitialSchema < ActiveRecord::Migration[8.1]
  def up
    ...
    # Enums
    create_enum "cra_status", %w[draft submitted locked]
  ...
  def down
    drop_table "user_missions", force: :cascade
    drop_table "user_cras", force: :cascade
    drop_table "user_companies", force: :cascade
    drop_table "sessions", force: :cascade
    drop_table "missions", force: :cascade
    drop_table "mission_companies", force: :cascade
    drop_table "cras", force: :cascade
    drop_table "cra_missions", force: :cascade
    drop_table "cra_entry_missions", force: :cascade
    drop_table "cra_entry_cras", force: :cascade
    drop_table "cra_entries", force: :cascade
    drop_table "companies", force: :cascade

    drop_enum "user_relation_role"
    drop_enum "user_company_role_enum"
    drop_enum "mission_type_enum"
    drop_enum "mission_status_enum"
    drop_enum "mission_company_role_enum"
    drop_enum "cra_status"
  end
end