...
# Alias Result for temporary compatibility
# All services should migrate to ApplicationResult.*
module Result
  def self.success(data:, message: nil, meta: {})
    ApplicationResult.success(data: data, message: message, meta: meta)
  end

  def self.created(data:, message: nil, meta: {})
    ApplicationResult.created(data: data, message: message, meta: meta)
  end

  def self.no_content(message: nil, meta: {})
    ApplicationResult.no_content(message: message, meta: meta)
  end
