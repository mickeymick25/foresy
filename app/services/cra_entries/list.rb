    ...
    class List
        ...
        def validate_business_rules
          ...
          if filters[:min_quantity].present?
            ...
            if min_quantity < 0 || min_quantity > ::Domain::CraEntry::CraEntry::MAX_QUANTITY
              return ApplicationResult.fail(
                error: :bad_request,
                status: :bad_request,
          ...
          if filters[:max_quantity].present?
            ...
            if max_quantity < 0 || max_quantity > ::Domain::CraEntry::CraEntry::MAX_QUANTITY
              return ApplicationResult.fail(
                error: :bad_request,
                status: :bad_request,
          ...
          if filters[:min_unit_price].present?
            ...
            if min_unit_price < 0 || min_unit_price > ::Domain::CraEntry::CraEntry::MAX_UNIT_PRICE
              return ApplicationResult.fail(
                error: :bad_request,
                status: :bad_request,
          ...
          if filters[:max_unit_price].present?
            ...
            if max_unit_price < 0 || max_unit_price > ::Domain::CraEntry::CraEntry::MAX_UNIT_PRICE
              return ApplicationResult.fail(
                error: :bad_request,
                status: :bad_request,
          ...
          if filters[:description].present? && filters[:description].length > ::Domain::CraEntry::CraEntry::MAX_DESCRIPTION_LENGTH
            return ApplicationResult.fail(
              error: :bad_request,
              status: :bad_request,
              message: "Description filter cannot exceed #{::Domain::CraEntry::CraEntry::MAX_DESCRIPTION_LENGTH} characters"
            )
          end
        ...
        def apply_sorting(query)
          ...
          unless valid_sort_fields.include?(sort_field)
            sort_field = 'date'
          end
